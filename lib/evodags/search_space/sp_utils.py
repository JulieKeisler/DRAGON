...
from lib.evodags.search_space.bricks.attention import SpatialAttention, TemporalAttention, Attention1D
from lib.evodags.search_space.bricks.basics import MLP, Identity, Zero
from lib.evodags.search_space.bricks.convolutions import Simple_2DCNN, Simple_1DCNN
...
def get_layers(args, input_shape, input_channels):
    from lib.evodags.search_space.cells import CandidateOperation
    combiner = args[0]
    name = args[1]
